...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a0000413 with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=DutchA.dll, Layout Id=00c1, Layout Component ID=3844B95343FB43D68E9695D6E88F016E
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a000040b with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=FinnishA.dll, Layout Id=00cb, Layout Component ID=ECE9937799D242F5AE0CAA446EDEDC62
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a000040c with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=FrenchA.dll, Layout Id=00c2, Layout Component ID=2ECD3C77364749B18E910F9196B420FA
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a0000407 with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=GermanA.dll, Layout Id=00c3, Layout Component ID=B616E2191BF048D4A554E5C6BE224AB4
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a0000410 with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=ItalianA.dll, Layout Id=00c4, Layout Component ID=6401AAA6058F431181B445C26BEF22D9
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a0000414 with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=NorwayA.dll, Layout Id=00c9, Layout Component ID=74BE397ABD8143E4960D38111394D1A3
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a0000415 with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=PolishA.dll, Layout Id=00cf, Layout Component ID=D3D2841618E34D09ABBCA0DA34A60FAE
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a0000416 with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=PortuguA.dll, Layout Id=00ce, Layout Component ID=326773935C8C4597B0738FE2084D44AD
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a0000419 with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=RussianA.dll, Layout Id=00c8, Layout Component ID=B0F62A69BE9446488ED502E800DBC36C
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a000040a with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=SpanishA.dll, Layout Id=00c5, Layout Component ID=C3364C7C44BC444A88A50459135D35B5
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a000041d with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=SwedishA.dll, Layout Id=00c7, Layout Component ID=8CC8067A1BFF4A0FAD38708DE4CD4BF1
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a000100c with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=SwissA.dll, Layout Id=00c6, Layout Component ID=CE4C7E2419DE400B8A553E1A5C3DCD04
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a0020409 with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=IntlEngA.dll, Layout Id=00d0, Layout Component ID=241A34D0-06DB-405e-8B4E-8CA2FC34D1C7
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a0000409 with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=USA.dll, Layout Id=00d1, Layout Component ID=B422390FE3C04f3a917D15AD1ACD710F
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would set Layout File=ChinaTA.dll under HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\00000404
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would set Layout File=ChinaSA.dll under HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\00000804
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a100041f with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=TurkeyA.dll, Layout Id=00d2, Layout Component ID=D1502D2EF02F4e4b8D313D3C0B0457D0
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a000041f with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=TurkeyQA.dll, Layout Id=00d3, Layout Component ID=2513D09A670B4d9bA8F1BDAAAA32176F
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a0000405 with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=CzechA.dll, Layout Id=00d4, Layout Component ID=0C8DA389245B4792B4960E336F62AC3E
) else (
...
if "%DRYRUN%"=="1" (
  echo DRYRUN: would add registry key HKLM\SYSTEM\CurrentControlSet\Control\Keyboard Layouts\a000040e with Layout Text="%LAYOUT_TEXT%"
  echo DRYRUN: would set Layout File=HungaryA.dll, Layout Id=00d5, Layout Component ID=725BE97D2AD14042BA539D96030F93AA
) else (
